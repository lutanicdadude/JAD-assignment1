...
<link href="${pageContext.request.contextPath}/view/resetPassword/resetPassword.css" rel="stylesheet">
</head>
<body>
	<header>
	...
	<div class="reset-card">
	    ...
	    <form action="${pageContext.request.contextPath}/CheckEmail" method="POST">
	      <div class="mb-3">
